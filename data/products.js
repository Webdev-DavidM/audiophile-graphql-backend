const products = [
    ...
    others: [
      {
        ...
        name: 'XX99 Mark I',
        image: '/assets/carousel/image-xx99-mark-one-headphones.jpg',
      },
      {
        slug: 'xx59-headphones',
        name: 'XX59',
        image: '/assets/carousel/image-xx59-headphones.jpg',
      },
      {
        slug: 'zx9-speaker',
        name: 'ZX9 Speaker',
        image: '/assets/carousel/image-zx9-speaker.jpg',
      },
      {
        slug: 'xx99-mark-two-headphones',
        name: 'XX99 Mark II',
        image: '/assets/carousel/image-xx99-mark-two-headphones.jpg',
      },
      {
        slug: 'xx99-mark-one-headphones',
        name: 'XX99 Mark I',
  ...
  },
  {
    ...
    features:
      'As the headphones all others are measured against, the XX99 Mark I demonstrates over five decades of audio expertise, redefining the critical listening experience. This pair of closed-back headphones are made of industrial, aerospace-grade materials to emphasize durability at a relatively light weight of 11 oz.\n\nFrom the handcrafted microfiber ear cushions to the robust metal headband with inner damping element, the components work together to deliver comfort and uncompromising sound. Its closed-back design delivers up to 27 dB of passive noise cancellation, reducing resonance by reflecting sound to a dedicated absorber. For connectivity, a specially tuned cable is items with a balanced gold connector.',
    items: [
      {
        quantity: 1,
        item: 'Headphone unit',
  ...
  },
  {
    ...
    features:
      'Featuring a genuine leather head strap and premium earcups, these headphones deliver superior comfort for those who like to enjoy endless listening. It items intuitive controls designed for any situation. Whether you’re taking a business call or just in your own personal space, the auto on/off and pause features ensure that you’ll never miss a beat.\n\nThe advanced Active Noise Cancellation with built-in equalizer allow you to experience your audio world on your terms. It lets you enjoy your audio in peace, but quickly interact with your surroundings when you need to. Combined with Bluetooth 5. 0 compliant connectivity and 17 hour battery life, the XX99 Mark II headphones gives you superior sound, cutting-edge technology, and a modern design aesthetic.',
    items: [
      {
        quantity: 1,
        item: 'Headphone unit',
